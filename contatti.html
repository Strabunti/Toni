...
<header>
    <div class="topnav">
        ...
        <div id="myLinks" role="navigation">
            ...
            <a href="aboutus.php" aria-label="About Us" role="link">About Us</a></li>
            <a href="contatti.php" aria-label="Contattaci!" role="link">Contattaci</a></li>
        </div>
    </div>
...
<nav class="main-nav" role="grid">
    <ul role="row">
        ...
        <li role="navigation"><a class="menu__item" href="aboutus.php" aria-label="About Us" role="link">About Us</a></li>
        <li role="navigation"><a class="menu__item" href="contatti.php" aria-label="Contattaci!" role="link">Contattaci</a></li>
    </ul>
</nav>
